...
module.exports = function () {
    ...
    // create new api service @param   route : route of the api          name : name
    // of the api          description : description of the api
    router
        .post('/create', function (req, res) {

            let { route, name, description, type } = req.body;
    ...
    router.post('/route/:route', function (req, res) {
        ...
        services
            .apiService
            .getApiByRoute(req.params.route)
            .then(function (result) {

                console.log("Successfull get api by route");
                services
                    .graphService
                    .getGraphById(result.graphId)
                    .then(function (graph) {
