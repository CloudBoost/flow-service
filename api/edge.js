...
module.exports = function () {
	...
	// add edge between 2 nodes in the existinng graph @param  startNode : id of the
	// start Node         endNode : id of the end node         endPort : IN port of
	// the end node         startPort : OUT port of the start node         graphId :
	// id of the graph

	router
		.put('/graph/edge', function (req, res) {
	...
	// delete edge form graph @param  graphId : id of the graphId         edgeId : id
	// of the edge in the graphId
